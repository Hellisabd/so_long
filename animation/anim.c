...
/*   Updated: 2024/02/23 13:41:46 by bgrosjea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long.h"

void	delete_sword(t_lo *g)
{
...
void	swords(t_lo *g)
{
	...
	{
		g->sword.frame1++;
		mlx_image_to_window(g->mlx, g->sword.tab[g->sword.frame1 - 1], \
		g->sword.x, g->sword.y);
	}
	if (i == 1)
	{
		g->sword.frame2--;
		mlx_image_to_window(g->mlx, g->sword.tab[g->sword.frame2 - 1], \
		g->sword.x, g->sword.y);
	}
}
